...
fdescribe('addColorToQueue', () => {
    ...
    it('should return 10 for the length of the array if the staring length is 10', () => {
...
fdescribe('changePreviewColor', () => {
    ...
    it('should change color to "a970eb" ', () => {
