...
export class StampToolService extends AbstractToolService {
    ...
    angle: StampAngleOrientation = StampAngleOrientation.Default;
    scaling: StampScaling = StampScaling.Default;
    ...
    setStamp(): void {
        this.renderer.setAttribute(this.stamp, HTMLAttribute.width, (STAMP_BASE_WIDTH * this.scaling).toString());
        this.renderer.setAttribute(this.stamp, HTMLAttribute.height, (STAMP_BASE_HEIGHT * this.scaling).toString());
    ...
    addStamp(): void {
        ...
        this.renderer.setAttribute(stamp, HTMLAttribute.width, (STAMP_BASE_WIDTH * this.scaling).toString());
        this.renderer.setAttribute(stamp, HTMLAttribute.height, (STAMP_BASE_HEIGHT * this.scaling).toString());
        ...
        this.renderer.setAttribute(rect, HTMLAttribute.width, (STAMP_BASE_WIDTH * this.scaling).toString());
        this.renderer.setAttribute(rect, HTMLAttribute.height, (STAMP_BASE_HEIGHT * this.scaling).toString());
