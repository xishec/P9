...
import { NO_STAMP, svgAttribute, BASE64_STAMPS_MAP } from 'src/constants/tool-constants';
...
export class StampToolService extends AbstractToolService {
    ...
    addStamp(): void {
        ...
        this.renderer.setAttribute(rect, svgAttribute.width, (this.STAMP_BASE_WIDTH * this.currentScaling).toString());
        this.renderer.setAttribute(rect, svgAttribute.height, (this.STAMP_BASE_HEIGHT * this.currentScaling).toString());
        this.renderer.setAttribute(rect, 'x', this.stampX.toString());
        this.renderer.setAttribute(rect, 'y', this.stampY.toString());
        this.renderer.setAttribute(rect, svgAttribute.fill, '#ffffff00');
